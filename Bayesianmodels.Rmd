...
```{r paths}
results_path_b<-"C:/Users/xy/Desktop/p4-INLASPDE/results-R-stepwise/backward"
results_path_f<-"C:/Users/xy/Desktop/p4-INLASPDE/results-R-stepwise/forward"
bart_results_path_b<-"C:/Users/xy/Desktop/p4-INLASPDE/results-R-bart/backward"
bart_results_path_f<-"C:/Users/xy/Desktop/p4-INLASPDE/results-R-bart/forward"
svr_results_path_b<-"C:/Users/xy/Desktop/p4-INLASPDE/results-R-svr/backward"
svr_results_path_f<-"C:/Users/xy/Desktop/p4-INLASPDE/results-R-svr/forward"
```
...
# check and repair the invalid geometric position
...
mycols <- c("#FFD700","#33a02c","#E41A1C","#1f78b4","#e7298a")

#_merged
m<-ggplot(shp) +
  geom_sf(aes(fill = Dat_Typ), color = "grey20", size = 0.4) +
  scale_fill_manual(values = mycols, name = "Dat_Typ") +
...
ggsave(filename = paste0(results_path_b, "/shp_I_LHHSI.png"), 
       plot = m, width = 6, height = 6, dpi = 300, bg="white")
dev.off()
```
...
mod_metrics2 <- function(obs, pred)
{
  ...
  R2 <- 1 - (SS_res / SS_tot1)                      # In-Sample coefficient of determination
  ROOS2 <- 1 - (SS_res / SS_tot2)                   # Out-Of-Sample coefficient of determination
...
```{r variable preparation and overdispersion test}
